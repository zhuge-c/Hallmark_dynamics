...
def Get_Hallmarks_gene(Hallmarks_path,network_file, Hallmark_gene_file, output_data):
    ################# 获取文件夹下所有txt
    ...
    pickle_data_hg={"HallMarks_gene":Total_Hallmarks_Gene}

    with open(Hallmark_gene_file, "wb") as f:
        pickle.dump(pickle_data, f)
