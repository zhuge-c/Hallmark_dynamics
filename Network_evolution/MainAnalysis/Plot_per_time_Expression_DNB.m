function Plot_per_time_Expression_DNB(Hallmarks,All_sample_X,DNB_score_dind,dt,total_t,figure_type,...
...
for g=1:gene
    ...
    [t2_1,t2_1_index]=max(DNB_score_dind);
   ...
   if id==t2_1_index
    ...
    print([file_path,'DIND_Expression',Hallmarks{g}],figure_type)
end
