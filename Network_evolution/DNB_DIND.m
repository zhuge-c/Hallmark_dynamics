...
for r = 1:round_num
    ...
    for t_i = 1:time_num
        ...
        [stage_data, stage_gene_pccs, ~, stage_node_neighbour_counts] = compute_stage_initial_graph(t_data, t_i, initial_pcc_thres);
...
%             stage_node_neighbour_counts % neighbor of each node
        ...
        edge_weights = compute_edge_weights(stage_data, stage_gene_pccs, stage_node_neighbour_counts, 0, reference_num);
